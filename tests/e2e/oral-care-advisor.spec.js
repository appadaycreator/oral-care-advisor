...
const SVC_URL = "https://appadaycreator.com/oral-care-advisor/";
const SVC_NAME = "歯・口腔ケア診断";

test.describe("歯・口腔ケア診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("oral-care-advisor");
